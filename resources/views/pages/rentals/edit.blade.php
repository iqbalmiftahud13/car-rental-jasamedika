                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="date"
                                                    name="start_date" id="start_date" required="required" value="{{ $rental->start_date }}" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="date"
                                                    name="end_date" id="end_date" required="required" value="{{ $rental->end_date }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    name="total_days" id="total_days" required="required" value="{{ $rental->total_days }}" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    name="total_cost" id="total_cost" required="required" value="{{ $rental->total_cost }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
